 ...
 *
 * DESCRIPCION
 *    Individuo para la resolucion del problema de Benchmark DTLZ2.
 *    
 *    El problema DTLZ2 esta definido en:
...
#ifndef __INDIVIDUALDTLZ2_H__
#define __INDIVIDUALDTLZ2_H__
