...
/*------------------------------------------------------------------------------------------
 * Funcion auxiliar para la ordenacion de pieces segun su profit
 * -------------------------------------------------------------------------------------------*/
...
void TDCSP::repair(void) {
	...
	//Cambiar una pieza por otra, un operador por otro, etc y evaluar de nuevo quedandome con el mejor
...
void TDCSP::insertOrderHole(int id, double param) {
        ...
        if (!orderHoles.empty()) {
                switch(typeOrder) {
                        case 0: 
                                for (vector<int>::iterator it = orderHoles.begin(); it < orderHoles.end(); it++) 
                                        if (holes[*it].a <= param) {	//Modificado con = !!!
