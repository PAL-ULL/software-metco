...
#ifndef __NSGA2_MultiObjectivized_Fuzzy_R_H__
#define __NSGA2_MultiObjectivized_Fuzzy_R_H__
...
class NSGA2_MultiObjectivized_Fuzzy_R : public EA {
		  
public:
	// Constructor
	NSGA2_MultiObjectivized_Fuzzy_R() {};
	...
	string getName() const { return "NSGA2_MultiObjectivized_Fuzzy_R"; }
