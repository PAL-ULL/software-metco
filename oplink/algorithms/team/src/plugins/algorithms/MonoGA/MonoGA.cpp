...
void MonoGA::binaryTournamentSelection(int &p1, int &p2){//Supone que population esta ordenada
...
// OJO: Para optimizacion multi-modal esto habrÃ que cambiarlo
