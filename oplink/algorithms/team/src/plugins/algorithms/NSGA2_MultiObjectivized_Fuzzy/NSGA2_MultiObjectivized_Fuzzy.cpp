...
#include "NSGA2_MultiObjectivized_Fuzzy.h"
#include <float.h>


// Define una generación de búsqueda del algoritmo 
void NSGA2_MultiObjectivized_Fuzzy::runGeneration() {
...
bool NSGA2_MultiObjectivized_Fuzzy::init(const vector<string> &params) {
...
void NSGA2_MultiObjectivized_Fuzzy::getSolution(MOFront *p) {
...
void NSGA2_MultiObjectivized_Fuzzy::printInfo(ostream &os) const {
	os << "Genetic Algorithm NSGA2_MultiObjectivized_Fuzzy" << endl;
 ...
 * ***********************************************************************/
void NSGA2_MultiObjectivized_Fuzzy::rankCrowdingPopulation() {
	int inserted = 0;
...
void NSGA2_MultiObjectivized_Fuzzy::rankPopulation() {
	vector < vector < Individual * > > fronts;
	vector < Individual *> notClassified;
 ...
 *  - Recombination
 * *****************************************************************************/
void NSGA2_MultiObjectivized_Fuzzy::createChildPop() {
...
void NSGA2_MultiObjectivized_Fuzzy::fillExternalArchive(){
	for (int i = 0; i < offSpring->size(); i++){
		insertInArchive((*offSpring)[i]);
	}
}
void NSGA2_MultiObjectivized_Fuzzy::multiObjectivize(vector <Individual*> *updatePop){
...
void NSGA2_MultiObjectivized_Fuzzy::exchangePerformed(){
	multiObjectivize(population);	
}

long double NSGA2_MultiObjectivized_Fuzzy::getFitValue() {
...
long double NSGA2_MultiObjectivized_Fuzzy::getVarValue() {
...
Individual* NSGA2_MultiObjectivized_Fuzzy::lookForBestIndividual() {
