...
#ifndef __NSGA2_MultiObjectivized_Fuzzy_B_TSK_H__
#define __NSGA2_MultiObjectivized_Fuzzy_B_TSK_H__
...
class NSGA2_MultiObjectivized_Fuzzy_B_TSK : public EA {
		  
public:
	// Constructor
	NSGA2_MultiObjectivized_Fuzzy_B_TSK() {};
	...
	string getName() const { return "NSGA2_MultiObjectivized_Fuzzy_B_TSK"; }
