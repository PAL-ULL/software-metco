...
#include "NSGA2_MultiObjectivized_Fuzzy_B_TSK.h"
#include <float.h>


// Define una generación de búsqueda del algoritmo 
void NSGA2_MultiObjectivized_Fuzzy_B_TSK::runGeneration() {
...
bool NSGA2_MultiObjectivized_Fuzzy_B_TSK::init(const vector<string> &params) {
...
void NSGA2_MultiObjectivized_Fuzzy_B_TSK::getSolution(MOFront *p) {
...
void NSGA2_MultiObjectivized_Fuzzy_B_TSK::printInfo(ostream &os) const {
	os << "Genetic Algorithm NSGA2_MultiObjectivized_Fuzzy_B_TSK" << endl;
 ...
 * ***********************************************************************/
void NSGA2_MultiObjectivized_Fuzzy_B_TSK::rankCrowdingPopulation() {
	int inserted = 0;
...
void NSGA2_MultiObjectivized_Fuzzy_B_TSK::rankPopulation() {
	vector < vector < Individual * > > fronts;
	vector < Individual *> notClassified;
 ...
 *  - Recombination
 * *****************************************************************************/
void NSGA2_MultiObjectivized_Fuzzy_B_TSK::createChildPop() {
...
void NSGA2_MultiObjectivized_Fuzzy_B_TSK::fillExternalArchive(){
	for (int i = 0; i < offSpring->size(); i++){
		insertInArchive((*offSpring)[i]);
	}
}
void NSGA2_MultiObjectivized_Fuzzy_B_TSK::multiObjectivize(vector <Individual*> *updatePop){
...
void NSGA2_MultiObjectivized_Fuzzy_B_TSK::exchangePerformed(){
	multiObjectivize(population);	
}

long double NSGA2_MultiObjectivized_Fuzzy_B_TSK::getFitValue() {
...
long double NSGA2_MultiObjectivized_Fuzzy_B_TSK::getBestPmInValue() {
	long double bestImprovement = improvementHistory[improvementHistory.size() - 1];
...
Individual* NSGA2_MultiObjectivized_Fuzzy_B_TSK::lookForBestIndividual() {
