 ...
 *   parameter R belonging to the NM operator
 * **********************************************************************************/


#ifndef __NSGA2_MultiObjectivized_Fuzzy_R_TSK_H__
#define __NSGA2_MultiObjectivized_Fuzzy_R_TSK_H__
...
class NSGA2_MultiObjectivized_Fuzzy_R_TSK : public EA {
		  
public:
	// Constructor
	NSGA2_MultiObjectivized_Fuzzy_R_TSK() {};
	...
	string getName() const { return "NSGA2_MultiObjectivized_Fuzzy_R_TSK"; }
