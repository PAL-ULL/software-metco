...
#include "NSGA2_MultiObjectivized_Fuzzy_B.h"
#include <float.h>


// Define una generación de búsqueda del algoritmo 
void NSGA2_MultiObjectivized_Fuzzy_B::runGeneration() {
...
bool NSGA2_MultiObjectivized_Fuzzy_B::init(const vector<string> &params) {
...
void NSGA2_MultiObjectivized_Fuzzy_B::getSolution(MOFront *p) {
...
void NSGA2_MultiObjectivized_Fuzzy_B::printInfo(ostream &os) const {
	os << "Genetic Algorithm NSGA2_MultiObjectivized_Fuzzy_B" << endl;
 ...
 * ***********************************************************************/
void NSGA2_MultiObjectivized_Fuzzy_B::rankCrowdingPopulation() {
	int inserted = 0;
...
void NSGA2_MultiObjectivized_Fuzzy_B::rankPopulation() {
	vector < vector < Individual * > > fronts;
	vector < Individual *> notClassified;
 ...
 *  - Recombination
 * *****************************************************************************/
void NSGA2_MultiObjectivized_Fuzzy_B::createChildPop() {
...
void NSGA2_MultiObjectivized_Fuzzy_B::fillExternalArchive(){
	for (int i = 0; i < offSpring->size(); i++){
		insertInArchive((*offSpring)[i]);
	}
}
void NSGA2_MultiObjectivized_Fuzzy_B::multiObjectivize(vector <Individual*> *updatePop){
...
void NSGA2_MultiObjectivized_Fuzzy_B::exchangePerformed(){
	multiObjectivize(population);	
}

long double NSGA2_MultiObjectivized_Fuzzy_B::getFitValue() {
...
long double NSGA2_MultiObjectivized_Fuzzy_B::getBestPmInValue() {
	long double bestImprovement = improvementHistory[improvementHistory.size() - 1];
...
Individual* NSGA2_MultiObjectivized_Fuzzy_B::lookForBestIndividual() {
