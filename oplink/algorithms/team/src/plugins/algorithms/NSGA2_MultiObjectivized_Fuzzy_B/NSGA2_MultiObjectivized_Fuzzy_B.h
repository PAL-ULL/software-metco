...
#ifndef __NSGA2_MultiObjectivized_Fuzzy_B_H__
#define __NSGA2_MultiObjectivized_Fuzzy_B_H__
...
class NSGA2_MultiObjectivized_Fuzzy_B : public EA {
		  
public:
	// Constructor
	NSGA2_MultiObjectivized_Fuzzy_B() {};
	...
	string getName() const { return "NSGA2_MultiObjectivized_Fuzzy_B"; }
