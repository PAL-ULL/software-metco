...
#ifndef __NSGA2_MultiObjectivizedWithReference_H__
#define __NSGA2_MultiObjectivizedWithReference_H__
...
class NSGA2_MultiObjectivizedWithReference : public EA {
		  
public:
	// Constructor
	NSGA2_MultiObjectivizedWithReference() {};
	...
	string getName() const { return "NSGA2_MultiObjectivizedWithReference"; }
