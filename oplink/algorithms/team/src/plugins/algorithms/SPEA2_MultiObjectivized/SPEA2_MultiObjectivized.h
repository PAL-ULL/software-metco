 ...
 *   SPEA2_MultiObjectivized. SPEA2_MultiObjectivized is an improved version of SPEA, proposed by Zitzler in 2001:
 *   -> Eckart Zitzler, Marco Laumanns, Lothar Thiele
 *      SPEA2_MultiObjectivized: Improving the Strength Pareto Evolutionary Algorithm.
 ...
 *
 *   SPEA2_MultiObjectivized has 3 main differences with SPEA:
 ...
 *
 *
 *   SPEA2_MultiObjectivized Algorithm
...
#ifndef __SPEA2_MultiObjectivized_H__
#define __SPEA2_MultiObjectivized_H__
...
class SPEA2_MultiObjectivized : public EA {

	public:
		// Constructor
		SPEA2_MultiObjectivized ();
	
		// Destructor
		virtual ~SPEA2_MultiObjectivized (void);
		...
		string getName() const { return "SPEA2_MultiObjectivized"; }
	...
	private:
		...
		//Calculate fictitious objectives
		void multiObjectivize(vector <Individual*> *updatePop);
