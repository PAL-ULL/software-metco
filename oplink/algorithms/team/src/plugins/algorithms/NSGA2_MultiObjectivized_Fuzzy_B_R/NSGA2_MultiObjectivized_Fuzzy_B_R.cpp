...
#include "NSGA2_MultiObjectivized_Fuzzy_B_R.h"
#include <float.h>


// Define una generación de búsqueda del algoritmo 
void NSGA2_MultiObjectivized_Fuzzy_B_R::runGeneration() {
...
bool NSGA2_MultiObjectivized_Fuzzy_B_R::init(const vector<string> &params) {
...
void NSGA2_MultiObjectivized_Fuzzy_B_R::getSolution(MOFront *p) {
...
void NSGA2_MultiObjectivized_Fuzzy_B_R::printInfo(ostream &os) const {
	os << "Genetic Algorithm NSGA2_MultiObjectivized_Fuzzy_B_R" << endl;
 ...
 * ***********************************************************************/
void NSGA2_MultiObjectivized_Fuzzy_B_R::rankCrowdingPopulation() {
	int inserted = 0;
...
void NSGA2_MultiObjectivized_Fuzzy_B_R::rankPopulation() {
	vector < vector < Individual * > > fronts;
	vector < Individual *> notClassified;
 ...
 *  - Recombination
 * *****************************************************************************/
void NSGA2_MultiObjectivized_Fuzzy_B_R::createChildPop() {
...
void NSGA2_MultiObjectivized_Fuzzy_B_R::fillExternalArchive(){
	for (int i = 0; i < offSpring->size(); i++){
		insertInArchive((*offSpring)[i]);
	}
}
void NSGA2_MultiObjectivized_Fuzzy_B_R::multiObjectivize(vector <Individual*> *updatePop){
...
void NSGA2_MultiObjectivized_Fuzzy_B_R::exchangePerformed(){
	multiObjectivize(population);	
}

long double NSGA2_MultiObjectivized_Fuzzy_B_R::getFitValue() {
...
long double NSGA2_MultiObjectivized_Fuzzy_B_R::getBestRInValue() {
	long double bestImprovement = improvementHistory[improvementHistory.size() - 1];
...
Individual* NSGA2_MultiObjectivized_Fuzzy_B_R::lookForBestIndividual() {
