...
#ifndef __NSGA2_MultiObjectivized_Fuzzy_B_Restart_H__
#define __NSGA2_MultiObjectivized_Fuzzy_B_Restart_H__
...
class NSGA2_MultiObjectivized_Fuzzy_B_Restart : public EA {
		  
public:
	// Constructor
	NSGA2_MultiObjectivized_Fuzzy_B_Restart() {};
	...
	string getName() const { return "NSGA2_MultiObjectivized_Fuzzy_B_Restart"; }
