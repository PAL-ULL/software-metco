 ...
 *   parameter R of the NM operator
 * **********************************************************************************/


#ifndef __NSGA2_MultiObjectivized_Fuzzy_B_R_TSK_H__
#define __NSGA2_MultiObjectivized_Fuzzy_B_R_TSK_H__
...
class NSGA2_MultiObjectivized_Fuzzy_B_R_TSK : public EA {
		  
public:
	// Constructor
	NSGA2_MultiObjectivized_Fuzzy_B_R_TSK() {};
	...
	string getName() const { return "NSGA2_MultiObjectivized_Fuzzy_B_R_TSK"; }
...
private:
  ...
  fl::InputVariable* rIn;
  fl::InputVariable* bestRIn;
  // Fuzzy Output Variables
  fl::OutputVariable* rOut;
