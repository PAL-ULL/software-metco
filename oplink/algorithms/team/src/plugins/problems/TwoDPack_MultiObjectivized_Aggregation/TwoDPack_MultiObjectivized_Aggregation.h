...
class TwoDPack_MultiObjectivized_Aggregation : public Individual{
	public:
		// Constructores y destructores
		TwoDPack_MultiObjectivized_Aggregation() { nInds++; }
		virtual ~TwoDPack_MultiObjectivized_Aggregation();
		...
		friend ostream& operator<< (ostream &os, const TwoDPack_MultiObjectivized_Aggregation &twoDPackingIndividual);
	...
	private:
		...
		//Crossover
		void subStringCrossover(TwoDPack_MultiObjectivized_Aggregation *ind);
