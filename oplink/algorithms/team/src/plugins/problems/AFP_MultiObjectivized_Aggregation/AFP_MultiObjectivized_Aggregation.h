...
#ifndef __AFP_MultiObjectivized_Aggregation_H__
#define __AFP_MultiObjectivized_Aggregation_H__
...
class AFP_MultiObjectivized_Aggregation : public Individual {
	public:
		AFP_MultiObjectivized_Aggregation(){};
		~AFP_MultiObjectivized_Aggregation(){};
