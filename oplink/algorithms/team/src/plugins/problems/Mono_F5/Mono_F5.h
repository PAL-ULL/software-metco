 ...
 *
 * DESCRIPCION
 * Shifted Griewank's Function (F5)
...
#ifndef __Mono_F5_H__
#define __Mono_F5_H__

#include "Individual.h"

class Mono_F5 : public Individual {
public:
	...
	// Ranges
	double inline getMaximum(const int i) const { return 600; }
	double inline getMinimum(const int i) const { return -600; }
