...
bool CEC10_LSGO_F6::init (const vector<string> &params){
...
Individual* CEC10_LSGO_F6::clone (void) const{
	return new CEC10_LSGO_F6();
}
...
// Rotated Elliptic Function for F6 & F4
...
// Rotated Elliptic Function for F9 & F64
...
// Rotated Rastrigin Function for F6~F8
