#ifndef __RND_COMPLETE_EVALUATIONS_H__
#define __RND_COMPLETE_EVALUATIONS_H__
...
#include "ProblemRND_CompleteEvaluations.h"
#include "utils.h"
...
#define CROSSOVER_HUX 3

class RND_CompleteEvaluations : public Individual {
	public:
		// Constructores y Destructor
		RND_CompleteEvaluations(){};
		~RND_CompleteEvaluations(); //{};
    ...
    void dependentMutation(double pm);
		...
		static ProblemRND_CompleteEvaluations *problem;              // Instancia del problema a resolver
