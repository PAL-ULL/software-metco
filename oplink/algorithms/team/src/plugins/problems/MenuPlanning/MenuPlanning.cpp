...
bool MenuPlanning::init(const vector<string>& params) {
    ...
    cout << "num_tipoPlato: " << num_tipoPlato << endl;
    cout << "NParams: " << nParam << endl;
    cout << "NObjs: " << nObj << endl;
#endif
    return true;
}
...
void MenuPlanning::set_vectorCompatibilidad(void) {
    ...
    cout << "Size primeros platos: " << v_primerosPlatos.size() << endl;
    cout << "Size segundos platos: " << v_segundosPlatos.size() << endl;
    cout << "Size postres: " << v_postres.size() << endl;
    for (int y = 0; y < v_primerosPlatos.size(); y++) {
        for (int x = 0; x < v_segundosPlatos.size(); x++) {
            for (int z = 0; z < v_postres.size(); z++) {
                cout << "v3_compatibilidadPlatos[y: " << y << "][x: " << x << "][z: " << z << "]: ";
                cout << v3_compatibilidadPlatos[y][x][z] << endl;
            }
        }
    }
#endif
