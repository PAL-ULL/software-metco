...
#ifndef __Mono_F19_SELFADAPTIVE_H__
#define __Mono_F19_SELFADAPTIVE_H__

#include "Individual.h"

class Mono_F19_SelfAdaptive : public Individual {
public:
...
private:
  // Auxiliar methods
  void divideFunctions(double *desp, double *part1, double *part2, int *psize1, int *psize2);
