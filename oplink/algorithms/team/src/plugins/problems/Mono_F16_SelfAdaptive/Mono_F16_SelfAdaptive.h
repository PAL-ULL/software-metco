...
#ifndef __Mono_F16_SELFADAPTIVE_H__
#define __Mono_F16_SELFADAPTIVE_H__

#include "Individual.h"

class Mono_F16_SelfAdaptive : public Individual {
public:
...
private:
  ...
  void divideFunctions(double *part1, double *part2, int *psize1, int *psize2);
	...
	long double Shifted_Sphere(int dim, const double *x);
