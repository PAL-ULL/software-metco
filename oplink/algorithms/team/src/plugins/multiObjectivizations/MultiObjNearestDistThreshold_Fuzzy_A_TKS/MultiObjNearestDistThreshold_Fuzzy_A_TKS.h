...
#ifndef MULTIOBJNEARESTDISTTHR_FUZZY_A_TKS_H 
#define MULTIOBJNEARESTDISTTHR_FUZZY_A_TKS_H 

#include "MultiObjectivization.h"
#include "fl/Headers.h"

class MultiObjNearestDistThreshold_Fuzzy_A_TKS : public MultiObjectivization {
