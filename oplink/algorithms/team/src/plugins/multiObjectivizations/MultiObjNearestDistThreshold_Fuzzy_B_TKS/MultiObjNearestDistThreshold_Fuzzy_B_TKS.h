...
#ifndef MULTIOBJNEARESTDISTTHR_FUZZY_B_TKS_H 
#define MULTIOBJNEARESTDISTTHR_FUZZY_B_TKS_H 

#include "MultiObjectivization.h"
#include "fl/Headers.h"

class MultiObjNearestDistThreshold_Fuzzy_B_TKS : public MultiObjectivization {
