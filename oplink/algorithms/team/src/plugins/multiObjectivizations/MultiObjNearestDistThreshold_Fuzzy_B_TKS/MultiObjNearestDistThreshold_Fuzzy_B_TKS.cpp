#include "MultiObjNearestDistThreshold_Fuzzy_B_TKS.h"

#include <stdlib.h>
#include <math.h>
#include <float.h>

bool MultiObjNearestDistThreshold_Fuzzy_B_TKS::init(const vector<string> &params) {
  if (params.size() != 4){
...
void MultiObjNearestDistThreshold_Fuzzy_B_TKS::convertToMultiObjective(vector<Individual *> *population, vector<Individual *> *offSpring, vector<Individual *> *reference, int ordObj, int numberGeneration) {
...
Individual* MultiObjNearestDistThreshold_Fuzzy_B_TKS::lookForBestIndividual(vector<Individual *> *population, vector<Individual *> *offSpring) {
...
long double MultiObjNearestDistThreshold_Fuzzy_B_TKS::getFitValue() {
...
long double MultiObjNearestDistThreshold_Fuzzy_B_TKS::getBestThrInValue() {
	long double bestImprovement = improvementHistory[improvementHistory.size() - 1];
...
bool MultiObjNearestDistThreshold_Fuzzy_B_TKS::updateObjectiveValue(vector<Individual *> *population, vector<Individual *> *offSpring, Individual *best, int ordObj) {
