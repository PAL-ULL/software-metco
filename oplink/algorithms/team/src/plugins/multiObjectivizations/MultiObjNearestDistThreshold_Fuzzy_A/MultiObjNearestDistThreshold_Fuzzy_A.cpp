#include "MultiObjNearestDistThreshold_Fuzzy_A.h"

#include <stdlib.h>
#include <math.h>
#include <float.h>

bool MultiObjNearestDistThreshold_Fuzzy_A::init(const vector<string> &params) {
  if (params.size() != 4){
...
void MultiObjNearestDistThreshold_Fuzzy_A::convertToMultiObjective(vector<Individual *> *population, vector<Individual *> *offSpring, vector<Individual *> *reference, int ordObj, int numberGeneration) {
...
Individual* MultiObjNearestDistThreshold_Fuzzy_A::lookForBestIndividual(vector<Individual *> *population, vector<Individual *> *offSpring) {
...
long double MultiObjNearestDistThreshold_Fuzzy_A::getFitValue() {
...
long double MultiObjNearestDistThreshold_Fuzzy_A::getVarValue() {
...
bool MultiObjNearestDistThreshold_Fuzzy_A::updateObjectiveValue(vector<Individual *> *population, vector<Individual *> *offSpring, Individual *best, int ordObj) {
