...
void CEC2013::load_goptima() 
{
	...
	std::string filename;
	if (nfunc_ == 1) {
		filename = "/home/edusegre/oplink/algorithms/team/src/skeleton/utils/CEC2013_MultiModal/data/F1_opt.dat";
	} else if (nfunc_ == 2) {
		filename = "/home/edusegre/oplink/algorithms/team/src/skeleton/utils/CEC2013_MultiModal/data/F2_opt.dat";
	} else if (nfunc_ == 3) {
		filename = "/home/edusegre/oplink/algorithms/team/src/skeleton/utils/CEC2013_MultiModal/data/F3_opt.dat";
	} else if (nfunc_ == 4) {
		filename = "/home/edusegre/oplink/algorithms/team/src/skeleton/utils/CEC2013_MultiModal/data/F4_opt.dat";
	} else if (nfunc_ == 5) {
		filename = "/home/edusegre/oplink/algorithms/team/src/skeleton/utils/CEC2013_MultiModal/data/F5_opt.dat";
	} else if (nfunc_ == 6) {
		filename = "/home/edusegre/oplink/algorithms/team/src/skeleton/utils/CEC2013_MultiModal/data/F6_2D_opt.dat";
	} else if (nfunc_ == 8) {
		filename = "/home/edusegre/oplink/algorithms/team/src/skeleton/utils/CEC2013_MultiModal/data/F6_3D_opt.dat";
	} else if (nfunc_ == 7) {
		filename = "/home/edusegre/oplink/algorithms/team/src/skeleton/utils/CEC2013_MultiModal/data/F7_2D_opt.dat";
	} else if (nfunc_ == 9) {
		filename = "/home/edusegre/oplink/algorithms/team/src/skeleton/utils/CEC2013_MultiModal/data/F7_3D_opt.dat";
	} else if (nfunc_ == 10) {
		filename = "/home/edusegre/oplink/algorithms/team/src/skeleton/utils/CEC2013_MultiModal/data/F8_2D_opt.dat";
	}
